...
// The token is generated by src/bargain_hunter/notify/render.py, which
// truncates the HMAC-SHA256 hex digest to 32 chars — every emailed link
// (past and future) uses that 32-char form, so verification must match it.
